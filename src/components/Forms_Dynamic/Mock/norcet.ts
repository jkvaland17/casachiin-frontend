    ...
    allFields: [
      {
        ...
        fields: [
          ...
          {
            name: "radio",
            title: "Are you contractual employee of CA?",
            value: "is_contractual_employee",
            col: 1,
            option: [
              {
                value: "yes",
          ...
          {
            name: "input",
            isShow: "is_contractual_employee",
            validator: ["yes"],
            title: "Type Of Institute",
            icon: "fa-solid fa-user",
            value: "contractual_employee_institute",
            col: 1,
          },
          {
            name: "input",
            ...
            isShow: "is_contractual_employee",
            validator: ["yes"],
            title: "Contractual Date Of Appointment From",
            icon: "fa-solid fa-user",
            value: "contractual_experience_start_date",
            col: 1,
          },
          {
            name: "input",
            ...
            isShow: "is_contractual_employee",
            validator: ["yes"],
            title: "Contractual Till Date",
            icon: "fa-solid fa-user",
            value: "contractual_experience_end_date",
            col: 1,
          },
          // Length of service(In Days)
          {
    ...
    allFields: [
      {
        ...
        fields: [
          ...
          },
          {
            ...
            icon: "fa-solid fa-suitcase-medical",
            value: "essential_education_qualification.university_name",
            col: 1,
          },
          {
            name: "input",
      ...
      },
      {
        ...
        fields: [
          ...
          {
            name: "input",
            title: "State Name of Nursing Council:",
            icon: "fa-solid fa-suitcase-medical",
            value: "reg_state",
            col: 1,
          },
