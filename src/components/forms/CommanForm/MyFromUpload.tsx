...
const MyFromUpload: React.FC<MyFromUploadProps> = ({
  formMethods,
  getValue,
  disabled,
}) => {
  ...
  const handleSelectClick = () => {
    if (disabled) {
      toast.error("Please click to edit button and change it.");
    }
  };
    ...
    <div className="position-relative">
      <div>
        ...
        <Controller
          name={getValue}
          control={control}
          rules={{ required: { value: true, message: "Please Select" } }}
          render={() => (
            <>
