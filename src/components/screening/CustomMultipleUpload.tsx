...
const CustomMultipleUpload: React.FC<customUploadProps> = ({
  preview,
  setPreview,
  handleChange,
  setValue,
  ...
  return (
    <div>
      ...
      <div className="mt-3 flex w-full items-center justify-center">
        <div
          className={`flex min-h-48 w-full flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 transition-all ${disabled ? "cursor-not-allowed opacity-50" : "cursor-pointer"}`}
