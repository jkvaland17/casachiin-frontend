        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3 mb-6">
              ...
              <p className="ml-4">
                (સન ૨૦૦૬ ના ગુજરાતના અધિનિયમ ક્રમાંક-૧૬) ની કલમ-૧૧ હેઠળ નોંધણી
                થવા માટે સક્ષમ છે.
              </p>

              <p>
                ૨. અંગત લગન અધિનિયમમાં મુકવામાં આવેલી શરતોનું પાલન કરતામાં
                આવ્યું છે.
              </p>

              <p>
                ૩. અરજીમાં આપવામાં આવેલી વિગતો અમારી ઉત્તમ જાણ અને માન્યતા
                પ્રમાણે ખરી છે,અને
              </p>
